...
public class MainWizard extends Wizard {
    ...
    public boolean performFinish() {
        if (canFinish()) {
            ...
            for (String name : values.keySet()) { // BEI GLEICHSTAND IMMER DER GLEICHE NAME IM ARRAY
            ...
            case 3:
                ...
                player3.addToGesamtzahlungen(ergebnisse[2] - ergebnisse[0] + ergebnisse[1] - ergebnisse[0]);
            ...
            case 4:
                ...
                player6.addToGesamtzahlungen(ergebnisse[3] - ergebnisse[0] + ergebnisse[2] - ergebnisse[0]);
                Player player7 = getPlayer(names[1]);
                player7.addToGesamtzahlungen(ergebnisse[3] - ergebnisse[1] + ergebnisse[2] - ergebnisse[1]);
    ...
    public boolean canFinish() {
        return ((this.getContainer().getCurrentPage() == first)
                && (this.getContainer().getCurrentPage().canFlipToNextPage())) ? true : false;
    }
}
