...
public class Main {
	...
	protected void createContents() {
		...
		lblAnzahlVersuche.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblAnzahlVersuche.setText("Anzahl Versuche:");
		
		versuche = new Label(shell, SWT.NONE);
		versuche.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false, false, 1, 1));
		versuche.setText("0");
